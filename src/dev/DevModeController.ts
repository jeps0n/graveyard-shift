...
export class DevModeController {
  ...
  setAfterMidnightAvailable(available: boolean): void {
    this.triggerAvailable = available;
    this.triggerButton.disabled = !available;
  }
  ...
  private updateTriggerButton(): void {
    ...
    this.triggerButton.disabled = !this.triggerAvailable;
